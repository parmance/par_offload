...
#define DEF_FUNCTION_TYPE_17(NAME, RETURN, ARG1, ARG2, ARG3, ARG4, ARG5, \
			     ARG6, ARG7, ARG8, ARG9, ARG10, ARG11,	\
			     ARG12, ARG13, ARG14, ARG15, ARG16, ARG17) NAME,
...
#define DEF_FUNCTION_TYPE_11(ENUM, RETURN, ARG1, ARG2, ARG3, ARG4,	\
  ...
  builtin_types[(int) ENUM]						\
    = build_function_type_list (builtin_types[(int) RETURN],		\
				...
				NULL_TREE);
#define DEF_FUNCTION_TYPE_17(ENUM, RETURN, ARG1, ARG2, ARG3, ARG4, ARG5,\
			     ARG6, ARG7, ARG8, ARG9, ARG10, ARG11,	\
  ...
  builtin_types[(int) ENUM]						\
    = build_function_type_list (builtin_types[(int) RETURN],		\
				...
				builtin_types[(int) ARG13],		\
				builtin_types[(int) ARG14],		\
				builtin_types[(int) ARG15],		\
				builtin_types[(int) ARG16],		\
				builtin_types[(int) ARG17],		\
				NULL_TREE);
